...
export function MenuSection() {
  ...
  // FIX: Ref for the scrollable preferences modal
  ...
  // FIX: This useEffect captures and handles mousewheel events for the modal content
  useEffect(() => {
  ...
  const handleAddToCart = (item: MenuItem) => {
    const selectedVariant = item.variants?.find(
      (v) => v.id === preferences.selectedVariant,
    );
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Experience authentic flavors crafted with love, premium ingredients,
                ...
                >
                  ...
                  <div>
                      ...
                      {[
                        ...
                        <button
                          ...
                          onClick={() =>
                            setPreferences((prev) => ({
                              ...prev,
                              extraDryFruits: option.value as any,
                            }))
                          }
                    ...
                    <div className="mt-3 text-xs text-gray-500 bg-gray-50 p-3 rounded-lg">
                      <div className="grid grid-cols-2 gap-2">
                        <div>
                          • <strong>Minimum:</strong> Light sprinkle
                        </div>
                        <div>
                          • <strong>Plus:</strong> Good amount
                        </div>
                        <div>
                          • <strong>Extra:</strong> Generous portion
                        </div>
                        <div>
                          • <strong>None:</strong> Just the dessert
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex justify-between items-center mt-1">
                      <span className="text-xs text-gray-500">
                        Optional - Let us know your preferences
                      </span>
                      <span className="text-xs text-gray-400">
                        {preferences.customNote.length}/200
                      </span>
                    </div>
                  </div>
                </div>
