...
export function Footer() {
  ...
  return (
    <footer
      ref={ref}
      className="bg-gradient-to-b from-orange-50 to-orange-100 py-20"
    >
      <div className="container mx-auto px-6">
        ...
        >
          <div className="mb-6">
            <span className="bg-orange-500 text-white px-4 py-2 rounded-full text-sm font-semibold">
              🇬🇧 UK's First Traditional Sweet Platform From Our Home to Yours
            </span>
          </div>

          <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-6">
            Begin Your Journey with{" "}
            <span className="text-orange-500">Our Family</span>
          </h2>

          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8">
            Experience the magic of traditional recipes made with pure milk,
            golden saffron, premium dry fruits, and creamy yogurt. Every order
            supports our dream of sharing authentic Indian sweets across the UK.
          </p>
            ...
            {[
              {
                ...
                desc: "On orders over £15 nationwide",
              },
              {
                icon: "💝",
                title: "Love Guaranteed",
                desc: "100% satisfaction with every bite",
              },
              {
                icon: "👨‍👩‍👧‍👦",
                title: "Growing Family",
                desc: "More traditional recipes coming soon",
              },
            ].map((feature, index) => (
              <motion.div
                key={index}
        ...
        >
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              Traditional family recipes delivering authentic sweet dishes
              across the UK.
            </p>
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3 text-gray-600">
                ...
                <span>
                  Delivering across London, Manchester, Birmingham & surrounding
                  areas
                </span>
              </div>
            </div>
        ...
        >
          <p className="text-gray-600">
            © 2024 The Sweet Spoon. All rights reserved. Made with love for
            traditional flavors.
          </p>
        </motion.div>
      </div>
